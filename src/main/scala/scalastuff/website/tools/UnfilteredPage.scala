...
object UnfilteredPage extends Page {
  def content(implicit context: TemplateContext) =
    <div>
	  <h1>Unfiltered</h1>
	  <h2>Description</h2>
	  This guy gets it. I totally agree with his argument of toolkits over <a href="http://unfiltered.lessis.me/#9">frameworks</a>. 

There are some nice quotes, like
...
lot of generated files.  
	  Go to <a href="http://unfiltered.lessis.me">ScalaBeans</a> page
	</div>
}